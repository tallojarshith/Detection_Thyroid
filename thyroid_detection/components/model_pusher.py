...
from thyroid_detection.cloud_storage.aws_storage import SimpleStorageService
from thyroid_detection.exception import ThyroidException
from thyroid_detection.logger import logging
from thyroid_detection.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = thyroidEstimator(bucket_name=model_pusher_config.bucket_name,
